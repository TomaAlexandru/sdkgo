 ...
 * @param "Description" (optional.) -  The description of the snapshot
 * @param "SecAuthProtection" (optional.) -  Flag representing if extra protection is enabled on snapshot e.g. Two Factor protection etc.
 * @param "LicenceType" (optional.) -  The OS type of this Snapshot
@return Snapshot
*/
func (a *VolumeApiService) DatacentersVolumesCreateSnapshotPost(ctx _context.Context, datacenterId string, volumeId string, optionals *DatacentersVolumesCreateSnapshotPostOpts) (Snapshot, *APIResponse, error) {
	...
	if optionals != nil && optionals.Name != nil {
		localVarFormParams.Add("name", parameterToString(*optionals.Name, ""))
	}
	if optionals != nil && optionals.Description != nil {
		localVarFormParams.Add("description", parameterToString(*optionals.Description, ""))
	}
	if optionals != nil && optionals.SecAuthProtection != nil {
		localVarFormParams.Add("secAuthProtection", parameterToString(*optionals.SecAuthProtection, ""))
	}
	if optionals != nil && optionals.LicenceType != nil {
		localVarFormParams.Add("licenceType", parameterToString(*optionals.LicenceType, ""))
	}
	if ctx != nil {
 ...
 * @param "Depth" (optional.) -  Controls the details depth of response objects.  Eg. GET /datacenters/[ID]  - depth=0: only direct properties are included. Children (servers etc.) are not included  - depth=1: direct properties and children references are included  - depth=2: direct properties and children properties are included  - depth=3: direct properties and children properties and children's children are included  - depth=... and so on
 * @param "XContractNumber" (optional.) -  Users having more than 1 contract need to provide contract number, against which all API requests should be executed
 * @param "SnapshotId" (optional.) -  This is the ID of the snapshot
@return map[string]interface{}
*/
func (a *VolumeApiService) DatacentersVolumesRestoreSnapshotPost(ctx _context.Context, datacenterId string, volumeId string, optionals *DatacentersVolumesRestoreSnapshotPostOpts) (map[string]interface{}, *APIResponse, error) {
	...
	if optionals != nil && optionals.SnapshotId != nil {
		localVarFormParams.Add("snapshotId", parameterToString(*optionals.SnapshotId, ""))
	}
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
